...
class Event(Document):
	...
	def on_update(self):
		...
		# frappe.throw('event update')
		# print(self.assign_to,'--------------------------update------------------------------------')
		...
		#message="Hi "+str(result[0][3])[2:-2]+" Task updates "+self.subject+" on "+self.starts_on
		#frappe.publish_realtime(event='msgprint',message=str(result),user='krupalvora789@gmail.com')
		print('-------------------------*****-------------------------------------')
		print('-------------------------*****-------------------------------------')
