...
erpnext.LeadController = class LeadController extends frappe.ui.form.Controller {
	...
	refresh () {
		...
		this.frm.set_query("custom_source_details", function() {
			let filters = {}
			filters['company'] = doc.company;
			return {
				query: "uniflowerp.uniflowerp.utils.lead.get_lead_source_details",
				filters: filters
			}
		});
...
frappe.ui.form.on("Lead", {
	...
	status: async function (frm){
		if (frm.doc.status == 'RNR5')
		{
			frm.doc.custom_stage = 'Unqualified';
